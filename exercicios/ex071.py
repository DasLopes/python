'''Crie um programa que simule o funcionamento de um caixa eletrônico. No início, pertunte ao usuário qual será o valor a ser sacado (número inteiro) e o programa vai informar quantas cédulas de cada valor serão entregues.
